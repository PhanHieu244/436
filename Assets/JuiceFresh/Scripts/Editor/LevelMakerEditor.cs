...
public class LevelMakerEditor : EditorWindow {
    ...
    #endregion
    void GUIHelp() {
        GUILayout.Label("Juice Fresh game template - v 1.2.1", EditorStyles.boldLabel, new GUILayoutOption[] { GUILayout.Width(350) });
        GUILayout.Space(10);
    ...
    void GUISettings() {
        ...
        if (GUILayout.Button("Install", new GUILayoutOption[] { GUILayout.Width(100) })) {
            Application.OpenURL("https://www.dropbox.com/s/4osvn9dfhlx8j2s/FacebookLeadboard.unitypackage?dl=0");
        }
        if (GUILayout.Button("Help", new GUILayoutOption[] { GUILayout.Width(80) })) {
                    ...
                    GUILayout.BeginVertical();
                    {
                        ...
                        if (target == Target.BLOCKS) {
                            GUILayout.BeginHorizontal();
                            {
                                ...
                                if (GUILayout.Button(blockTex, new GUILayoutOption[] { GUILayout.Width(50), GUILayout.Height(50), GUILayout.MaxWidth(50) })) {
